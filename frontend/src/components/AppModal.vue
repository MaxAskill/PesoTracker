<template>
  <Teleport to="body">
    ...
    >
      <div
        class="relative z-[140] max-h-[92vh] w-full overflow-y-auto rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-950 via-slate-950 to-slate-900 p-6 text-white shadow-2xl shadow-black/60 sm:max-h-[90vh] sm:p-8"
        :class="sizeClass"
        @click.stop
      >
